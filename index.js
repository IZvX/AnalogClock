...
function theme() {
    if (dark.checked == false) {
        root.style.setProperty("--primary","#f1f7ff")
        root.style.setProperty("--secondary","#091921")
        root.style.setProperty("--hour","#F81460")
        root.style.setProperty("--minute","#091921")
        ...
        clock.style = "background-image: url(dark.png);"
        ball.style = "background-image: url(Sun.png); transform : translateX(0px);"
        
    }else{
        root.style.setProperty("--primary","#091921")
        root.style.setProperty("--secondary","#f1f7ff")
        root.style.setProperty("--hour","#F81460")
        root.style.setProperty("--minute","#f1f7ff")
        root.style.setProperty("--second","#1A74BE")
        clock.style = "background-image: url(white.png);"
